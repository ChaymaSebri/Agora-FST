...
import { z } from "zod";
import { ApiError, fetchClubs, fetchEventById, updateEvent, fetchCompetences, fetchTeachers, fetchEventInvitations } from "@/services/api";
  ...
  useEffect(() => {
    const loadEvent = async () => {
      ...
      try {
        ...
        try {
          const invitations = await fetchEventInvitations(id);
          setInviteTeacherIds(
            invitations
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Les enseignants sélectionnés recevront une invitation à cet événement.
                </p>
