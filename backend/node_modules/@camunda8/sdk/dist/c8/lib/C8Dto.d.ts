...
export interface CreateProcessInstanceFromProcessDefinitionKey<V extends JSONDoc | LosslessDto> extends CreateProcessBaseRequest<V> {
    /**
...
export declare class UserItem extends LosslessDto {
    /** The ID of the user. */
    id: string;
    /** The key of the user. */
    key: string;
