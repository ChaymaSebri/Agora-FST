...
router.get('/:clubId/students', authenticate, authorizeRoles('club', 'admin'), clubsController.listClubStudents);
...
router.delete('/membership-requests/:requestId', authenticate, authorizeRoles('etudiant'), clubsController.cancelMembershipRequest);
